 ...
 * @tparam CoordinateMap Type satisfying CoordinateMap concept
 */

template <class Element, class ParametersType, class PointMap, class CoordinateMap>
...
class basic_pass_through_filter_t
{
  public:
    ...
    basic_pass_through_filter_t(
        ...
        : point_map_(point_map), coordinate_map_(coordinate_map), params_(params)
    {
    }
    /**
     * @brief
    ...
    {
        auto const p_one_coordinate = coordinate_map_(point_map_(p))[params_.index_to_filter_];
        return (
